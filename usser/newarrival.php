                ...
                <div class="flex items-center gap-5">
                    ...
                    <div class="cursor-pointer hover:text-gray-300 transition-colors">
                        ...
                        if(isset($_SESSION['user_id'])){
                            echo "<a href='dashboard.php' class='text-white hover:text-gray-300'><i class='far fa-user text-lg'></i></a>";
                        }else{
    ...
    <nav class="bg-adios-bg py-4 border-b border-gray-300">
        <div class="max-w-6xl mx-auto px-5">
            <ul class="flex flex-wrap justify-center gap-6 lg:gap-12">
                ...
                <li><a href="#" class="text-black font-bold text-lg uppercase hover:text-adios-red transition-colors">THE NEW ARRIVALS</a></li>
            </ul>
        </div>
    </nav>
